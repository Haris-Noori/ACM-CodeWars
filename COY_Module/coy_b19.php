...
<head>
    ...
    <title>Coder Of The Year | Batch 19 - Code Wars</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Coder Of The Year -  Batch 19'</h1>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        Given a sorted(Ascending order) array as input. Return true if you can split it into two
                                        subsequences such that both subsequences have consecutive numbers, same sum
                                        and have a minimum length of 3 .
                                    </p>
                                    <p class="font-weight-bold">Example:</p>
                                    <code>
                                        <p>Input: [1,2,3,4,4,5,5,6]</p>
                                        <p>Output: True</p>
                                        <p>Description:</p>
                                        <p>[1,2,3,4,5] sum ⇒ 15</p>
                                        <p>[4,5,6] sum ⇒ 15</p>
                                    </code>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        Given a 2d array of ‘1’s and ‘0’s , return the number of ‘1’s which have ‘0’s on all sides.
                                    </p>
                                    <p class="font-weight-bold">Example:</p>
                                    <code>
                                        <p>Input: 2d array = [</p>
                                        <p class="ml-5">[1,0,1,0,0],</p>
                                        <p class="ml-5">[0,1,1,1,0],</p>
                                        <p class="ml-5">[1,1,0,0,0],</p>
                                        <p class="ml-5">[0,0,0,0,0]</p>
                                        <p>]</p>
                                        <p>Output: 1</p>
                                    </code>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <p>
                                        A Binary Tree exists in memory. Find and return the maximum path sum.
                                        For this problem, a path is defined as any node sequence from some starting node to
                                        any node in the tree along the parent child connection. The path must contain at least
                                        one node and does not need to go through the root.
                                    </p>
                                    <p class="font-weight-bold">Example:</p>
                                    <code>
                                        <p>Input: root = [-10,9,20,null,null,15,7] ( A Preorder representation of the binary tree)</p>
                                        <p>Output: 42</p>
                                    </code>

                                    <p class="font-weight-bold">Template:(You have to use this)</p>
                                    <code>
                                        <p>// Definition for a binary tree node.</p>
                                        <p class="ml-3">struct TreeNode {</p>
                                            <p class="ml-5">int val;</p>
                                            <p class="ml-5">TreeNode *left;</p>
                                            <p class="ml-5">TreeNode *right;</p>
                                            <p class="ml-5">TreeNode() : val(0), left(nullptr), right(nullptr) {}</p>
                                            <p class="ml-5">TreeNode(int x) : val(x), left(nullptr), right(nullptr) {}</p>
                                            <p class="ml-5">TreeNode(int x, TreeNode *left, TreeNode *right) : val(x), left(left), right(right) {}</p>
                                        <p class="ml-3">};</p>

                                        <p class="ml-3">class Solution {</p>
                                        <p class="ml-3">public:</p>
                                            <p class="ml-5">int maxPathSum(TreeNode* root) {</p>
                                            <p class="ml-5">}</p>
                                        <p class="ml-3">};</p>
                                    </code>
                                </div>
                    ...
                    <div class="container">
                        ...
                        if(isset($_POST["btn-submit"]))
                        {
                            ...
                            {
                                $file_path = 'submissions/batch19/'.$_SESSION["user_name"];
