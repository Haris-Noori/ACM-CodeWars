...
<head>
    ...
    <title>Dashboard - Code Wars</title>
                        ...
                        <div class="col-md-8 mb-4">
                            <div class="card shadow h-100 py-2" style=" border-left-width: 5px; border-left-color: #00FCBF">
                                <div class="card-body">
                                    ...
                                    <div class="container">
                                        <div class="row">1. Rule number one</div>
                                        <div class="row">2. Rule number two</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="file" class="col-md-4 btn btn-outline-info">
